...
- `do_research`: Use `/research` to research an assignment or repo context and produce a clear `research.md` without implementing code or writing an implementation plan.
- `planning`: Use `/plan` to turn `research.md` and repo context into a phase-by-phase `implementation_plan.md` for a coding agent to execute.
